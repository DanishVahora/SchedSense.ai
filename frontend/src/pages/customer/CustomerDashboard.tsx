...
const CustomerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Add CustomerNavbar here */}
      <CustomerNavbar />

      <div className="relative z-10">
        {/* Hero Section - Add padding-top to account for the navbar */}
        <div className="px-6 pt-28 pb-20"> {/* Increased top padding to accommodate navbar height */}
